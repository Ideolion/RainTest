...
//двигаясь слева на право охраняем в массив максимальное значение для каждого элемента первоначального массива из тех элементов что позади него
        int LeftMax = 0;
...
// чтобы понять сможет ли вода задержаться в этих границах и считаем количество воды (положительное значение столбика воды)
        for(int i=0;i<height.length;i++){
